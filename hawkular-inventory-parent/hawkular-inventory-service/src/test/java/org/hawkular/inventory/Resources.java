...
public final class Resources {
    ...
    public static final Metric METRIC1
            = new Metric("Memory", "memory1", MetricUnit.BYTES, new HashMap<>(), new HashMap<>());
    public static final Metric METRIC2
            = new Metric("GC", "gc1", MetricUnit.NONE, new HashMap<>(), new HashMap<>());
    public static final Metric METRIC3
            = new Metric("Memory", "memory2", MetricUnit.BYTES, new HashMap<>(), new HashMap<>());
    public static final Metric METRIC4
            = new Metric("GC", "gc2", MetricUnit.NONE, new HashMap<>(), new HashMap<>());
