...
apidocFile.append "== Version 4 (${swagger['info']['version']}) \n"
...
private writeEndpointHeader(Writer writer, Entry path, Entry method) {
    ...
    def consumes = method.value.consumes
    def produces = method.value.produces
...
"""
        ...
        .each { Entry property ->
            ...
            def required = required(property.value.required)
