...
FILE_NAME="rest-inventory-v4.adoc"
FILE_PATH="hawkular-inventory-parent/hawkular-inventory-service/target/generated/$FILE_NAME"
...
TEMP_CURL_CONTENT="$(pwd)/curl-inventory.json"
echo "{\"path\": \"$FILE_NAME\", \"message\": \"Travis CI (inventory): updating REST documentation\", \"commiter\": {\"name\": \"Travis CI\", \"email\": \"foo@bar.com\"}, \"sha\": \"$SHA\", \"content\": \"$CONTENT\", \"branch\": \"$BRANCH\"}">$TEMP_CURL_CONTENT
