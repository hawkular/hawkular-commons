...
public class InventoryServiceTest {
    ...
    private static final Metric METRIC1
            = new Metric("m-1", "memory", "feed", MetricUnit.BYTES, 10, new HashMap<>());
    private static final Metric METRIC2
            = new Metric("m-2", "gc", "feed", MetricUnit.NONE, 10, new HashMap<>());
    private static final Metric METRIC3
            = new Metric("m-3", "memory", "feed", MetricUnit.BYTES, 10, new HashMap<>());
    private static final Metric METRIC4
            = new Metric("m-4", "gc", "feed", MetricUnit.NONE, 10, new HashMap<>());
